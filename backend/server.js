...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://localhost:5174", "https://frontend-chayhana.onrender.com", "https://front-admin-chayhana.onrender.com", "http://www.chayhana-n1-sultan.ru"], // Р азрешаем запросы с указанных доменов
